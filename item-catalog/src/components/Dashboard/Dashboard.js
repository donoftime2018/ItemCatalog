            ...
            return(<>
                {
                    items.filter(item=>flexibleRegex.test(item.name) || flexibleRegex.test(item.desc)).map((item, index)=>{
                        return(<>
                            <Item itemName={item.name} itemWebsite={item.website} itemDesc={item.desc} itemQuantity={item.quantity} itemPoster={item.poster} itemRatedByUser={item.usersRated.includes(user)} itemPrice={item.price} itemRating={item.rating} dateCreated={item.createdAt} lastUpdated={item.updatedAt} id={index} dbID={item._id}></Item>
                        </>)
                    })
                }
            </>)
            ...
            return(<>
                {
                    items.filter(item=>new RegExp(posterQuery).test(item.poster)).map((item, index)=>{
                        return(<>
                            <Item itemName={item.name} itemWebsite={item.website} itemQuantity={item.quantity} itemDesc={item.desc} itemPoster={item.poster} itemRatedByUser={item.usersRated.includes(user)} itemPrice={item.price} itemRating={item.rating} dateCreated={item.createdAt} lastUpdated={item.updatedAt} id={index} dbID={item._id}></Item>
                        </>)
                    })
                }
            </>)
